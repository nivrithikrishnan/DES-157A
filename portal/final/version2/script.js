...
(function(){
    ...
    alert("hello! for the user testing, i would like to test the functionality of the slideshow (transtions, animations, spacing) as well as the pop-up card for each image.");
